...
/*定义三级分类数据*/
//一级分类
var province = ["美食","文艺", "青春", "生活", "人文社科", "经管", "科技", "电子书"];
//二级分类
var city = [
    ["零食","生鲜"],
	["文学", "传记", "艺术", "摄影"],
	["青春文学", "动漫", "幽默"],
	["服装","休闲/爱好", "孕产/胎教", "烹饪/美食", "时尚/美妆", "旅游/地图", "家庭/家居", "亲子/家教", "两性关系", "育儿/早教", "保健/养生"],
	["历史", "文化", "古籍", "心理学", "哲学/宗教"],
	["管理", "投资理财", "经济"],
...
/*		alert($("#selectedSort").html());*/
		location.href = "addCommodity.jsp?category="+encodeURIComponent($("#selectedSort").html());//跳转到下一页
	}
});
